...
public class Common {
    public static int BOX_LAYER_ID = 7;
    public static int BOX_LAYER_MASK = 1 << BOX_LAYER_ID;
    public static string RESOURCE_BOX_TAG = "ResourceBox";
    public static string RESOURCE_BOX_HELD_TAG = "HeldBox";
    public static string ORDER_PREP_TABLE_TAG = "OrderPrep";
    public static string BOX_HELD_BY_BOT_TAG = "CleanerBotHeldBox";
    public static string DISPOSED_BOX_TAG = "Disposed";
